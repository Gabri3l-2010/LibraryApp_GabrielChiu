...
public class Main extends Application {
    ...
    public static String rutaDashboardSegunRol() {
        ...
        if (usuario == null || usuario.getRol() == null) {
            return "/org/gc/view/fxml/InicioSesionView.fxml";
        }
        switch (usuario.getRol().toLowerCase()) {
            case "admin":
                return "/org/gc/view/fxml/AdminDashboradView.fxml";
            case "empleado":
                return "/org/gc/view/fxml/EmpleadoView.fxml";
            case "cajero":
                return "/org/gc/view/fxml/CajeroView.fxml";
            default:
                return "/org/gc/view/fxml/InicioSesionView.fxml";
        }
    }
    ...
    public void start(Stage escenarioPrincipal) throws Exception {
        ...
        cambiarEscena("/org/gc/view/fxml/InicioSesionView.fxml");
    }
}
