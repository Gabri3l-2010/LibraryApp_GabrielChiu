...
import org.gc.dao.impl.ClienteDAOImpl;
import org.gc.dao.impl.UsuarioDAOImpl;
import org.gc.dao.impl.VentaDAOImpl;
...
public class ListaVentasController implements Initializable {
    ...
    private void handleVerFactura() {
        ...
        try {
            Main.cambiarEscena("/org/gc/view/fxml/FacturaView.fxml");
        } catch (Exception e) {
